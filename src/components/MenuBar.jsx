      ...
      >
        ...
        <div id="qrCode" ref={qrRef}>
          ...
          >
            <div
              className={`absolute ${
                ThemeMode === "dark" ? "bg-[#0c0c0c]" : "bg-white"
        ...
        <Link to="/stamp" className="w-[60px]">
          <Icon
            ...
            icon="stamp"
            size="26px"
            green={pathname === "/stamp" ? true : false}
          />
        </Link>
        <Link to="/mypage" className="w-[60px]">
          <Icon
            text={userData ? t(`menu.mypage`) : t(`menu.mypage2`)}
            icon="user"
            size="26px"
            green={pathname === "/mypage" ? true : false}
          />
        </Link>
      </nav>
    </>
